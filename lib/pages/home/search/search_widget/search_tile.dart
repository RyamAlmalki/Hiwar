  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListTile(
        ...
        //   child: Text('${widget.conversation?.fullName}', style: TextStyle(color: textColor, fontWeight: FontWeight.normal, fontSize: 15),),
        // ),
        ...
        onTap: (){
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) =>  MessageScreen(userId: conversation?.userId, numberOfUnseenMessages: 0, lastSavedConversationDate: conversation?.lastSavedConversationDate, chatId: conversation?.id, conversation: conversation,)),
          );
        },
      ),
    );
